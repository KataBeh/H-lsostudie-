...
## Syfte:
Målet med Del2 är att fördjupa analysen som jag tidigare byggde genom att strukturera koden bättre, skapa en klass, göra fler visualiseringar och testa linjär regression i praktiken.
